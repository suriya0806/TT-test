  ...
  return (
    <div id="constraints-view" className="p-6 space-y-6 max-w-5xl mx-auto">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 shadow-xs space-y-4 transition-colors">
        <div className="flex items-center gap-2 text-rose-700 dark:text-rose-400 border-b border-slate-100 dark:border-slate-800 pb-3">
          <ShieldAlert className="w-5 h-5" />
          <div>
            <h3 className="font-bold text-sm text-slate-900 dark:text-slate-100">Hard Constraints (Strict Non-Negotiable)</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
          <div
            ...
            className={`p-3.5 rounded-lg border text-xs cursor-pointer transition-all flex items-start gap-3 ${
              hard.teacherConflict
                ? 'bg-rose-50/60 dark:bg-rose-950/40 border-rose-200 dark:border-rose-800 text-rose-900 dark:text-rose-200'
          ...
          >
            ...
            />
            <div>
              <span className="font-bold text-slate-900 dark:text-slate-100 block">Teacher Conflict Check</span>
          ...
          >
            ...
            />
            <div>
              <span className="font-bold text-slate-900 dark:text-slate-100 block">Class Clash Prevention</span>
              <span className="text-[11px] text-slate-600 dark:text-slate-400">
          ...
          >
            ...
            />
            <div>
              <span className="font-bold text-slate-900 dark:text-slate-100 block">Subject Eligibility Check</span>
              <span className="text-[11px] text-slate-600 dark:text-slate-400">
          ...
          >
            ...
            />
            <div>
              <span className="font-bold text-slate-900 dark:text-slate-100 block">Faculty Workload Ceiling</span>
              <span className="text-[11px] text-slate-600 dark:text-slate-400">
          ...
          >
            ...
            />
            <div>
              <span className="font-bold text-slate-900 dark:text-slate-100 block">Consecutive Block Constraint</span>
              <span className="text-[11px] text-slate-600 dark:text-slate-400">
                Labs and skill modules (e.g. 2, 3, or 4 consecutive periods for Naan Mudhalvan) must be scheduled contiguously.
              </span>
            </div>
          </div>
          ...
          >
            ...
            />
            <div>
              <span className="font-bold text-slate-900 dark:text-slate-100 block">Teacher Unavailability Respect</span>
              <span className="text-[11px] text-slate-600 dark:text-slate-400">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 shadow-xs space-y-4 transition-colors">
        <div className="flex items-center gap-2 text-indigo-700 dark:text-indigo-400 border-b border-slate-100 dark:border-slate-800 pb-3">
          <Sliders className="w-5 h-5" />
          <div>
            <h3 className="font-bold text-sm text-slate-900 dark:text-slate-100">Soft Constraints (Quality Optimization)</h3>
            <p className="text-[11px] text-slate-500 dark:text-slate-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
          <div
            ...
            className={`p-3.5 rounded-lg border text-xs cursor-pointer transition-all flex items-start gap-3 ${
              soft.balanceTeacherWorkload
                ? 'bg-indigo-50/60 dark:bg-indigo-950/40 border-indigo-200 dark:border-indigo-800 text-indigo-950 dark:text-indigo-200'
                : 'bg-slate-50 dark:bg-slate-800/40 border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 opacity-60'
            }`}
          >
            <input
            ...
            />
            <div>
              <span className="font-bold text-slate-900 dark:text-slate-100 block">Balance Faculty Workload</span>
              <span className="text-[11px] text-slate-600 dark:text-slate-400">
          ...
          >
            ...
            />
            <div>
              <span className="font-bold text-slate-900 dark:text-slate-100 block">Spread Subjects Evenly</span>
              <span className="text-[11px] text-slate-600 dark:text-slate-400">
          ...
          >
            ...
            />
            <div>
              <span className="font-bold text-slate-900 dark:text-slate-100 block">Avoid Faculty Fatigue</span>
              <span className="text-[11px] text-slate-600 dark:text-slate-400">
          ...
          >
            ...
            />
            <div>
              <span className="font-bold text-slate-900 dark:text-slate-100 block">Shuffle & Rotate Subject Hours Daily</span>
              <span className="text-[11px] text-slate-600 dark:text-slate-400">
          ...
          >
            ...
            />
            <div>
              <span className="font-bold text-slate-900 dark:text-slate-100 block">Randomized Slot Shuffling</span>
              <span className="text-[11px] text-slate-600 dark:text-slate-400">
          ...
          >
            ...
            />
            <div>
              <span className="font-bold text-slate-900 dark:text-slate-100 block">Preserve Existing Assignments</span>
              <span className="text-[11px] text-slate-600 dark:text-slate-400">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 shadow-xs space-y-4 transition-colors">
        <div className="border-b border-slate-100 dark:border-slate-800 pb-3">
          <h3 className="font-bold text-sm text-slate-900 dark:text-slate-100">Dynamic Constraint Builder</h3>
          <p className="text-[11px] text-slate-500 dark:text-slate-400">
        ...
        <div className="p-4 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-800 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
          <div>
            <label className="block text-[11px] font-semibold text-slate-600 dark:text-slate-300 mb-1">Rule Type</label>
            <select
              value={dynType}
          ...
          {dynType.startsWith('TEACHER') && (
            <div>
              <label className="block text-[11px] font-semibold text-slate-600 dark:text-slate-300 mb-1">Select Faculty</label>
              <select
                value={dynStaffId}
                onChange={(e) => setDynStaffId(e.target.value)}
                className="w-full px-2.5 py-1.5 text-xs rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 font-medium cursor-pointer"
              >
                {staffList.map((s) => (
          ...
          {dynType.startsWith('SUBJECT') || dynType === 'NO_SUBJECT_ON_DAY' ? (
            <div>
              <label className="block text-[11px] font-semibold text-slate-600 dark:text-slate-300 mb-1">Select Subject</label>
              <select
                value={dynSubjectId}
          ...
          {dynType === 'TEACHER_TIME_WINDOW' && (
            <div>
              <label className="block text-[11px] font-semibold text-slate-600 dark:text-slate-300 mb-1">Window</label>
              <select
                value={dynWindow}
          ...
          {(dynType === 'TEACHER_UNAVAILABLE_SPECIFIC' || dynType === 'NO_SUBJECT_ON_DAY') && (
            <div>
              <label className="block text-[11px] font-semibold text-slate-600 dark:text-slate-300 mb-1">Day</label>
              <select
                value={dynDay}
          ...
          {dynType === 'TEACHER_UNAVAILABLE_SPECIFIC' && (
            <div>
              <label className="block text-[11px] font-semibold text-slate-600 dark:text-slate-300 mb-1">Period</label>
              <input
                type="number"
                min={1}
                max={10}
                ...
                className="w-full px-2.5 py-1.5 text-xs rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 font-medium"
              />
            </div>
          )}
          ...
          {dynType === 'SUBJECT_DAILY_MAX' && (
            <div>
              <label className="block text-[11px] font-semibold text-slate-600 dark:text-slate-300 mb-1">Max Periods / Day</label>
              <input
                type="number"
                min={1}
                max={10}
          ...
          <div className="flex items-end">
            <button
              ...
              className="w-full py-1.5 text-xs font-semibold text-white bg-slate-900 hover:bg-slate-800 dark:bg-indigo-600 dark:hover:bg-indigo-500 rounded-lg transition-colors flex items-center justify-center gap-1.5 shadow-xs cursor-pointer"
            >
        ...
        <div className="space-y-2">
          {dynamic.map((dyn) => (
            <div
              key={dyn.id}
              className="p-3 bg-white dark:bg-slate-800/70 rounded-lg border border-slate-200 dark:border-slate-700 flex items-center justify-between text-xs hover:border-slate-300 dark:hover:border-slate-600 transition-colors"
            >
              <div className="flex items-center gap-3">
                ...
                />
                <span className={`font-semibold ${dyn.enabled ? 'text-slate-800 dark:text-slate-200' : 'text-slate-400 dark:text-slate-500 line-through'}`}>
                  {dyn.name}
                </span>
              </div>
